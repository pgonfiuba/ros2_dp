...
def generate_launch_description():
    ...
    controllers_file = os.path.join(pkg_dp, 'config', 'ros2_controllers.yaml')
    
    #urdf_file = os.path.join(pkg_dp, 'urdf', 'double_pendulum.urdf')
    xacro_file = os.path.join(pkg_dp, 'urdf', 'double_pendulum.xacro')
    urdf_content = process_file(xacro_file).toxml()
    urdf_file = os.path.join(pkg_dp, 'urdf', 'double_pendulum.xacro')
